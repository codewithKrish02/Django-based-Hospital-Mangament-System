...
urlpatterns = [
    ...
    path('adminDeleteDoctor(?P<int:pid>,?P<str:email>)',admin_delete_doctor,name='admin_delete_doctor'),
    ...
    path('adminDeleteReceptionist(?P<int:pid>,?P<str:email>)',admin_delete_receptionist,name='admin_delete_receptionist'),
    ...
    path('PatientDeleteAppointment(?P<int:pid>)',patient_delete_appointment,name='patient_delete_appointment'),
